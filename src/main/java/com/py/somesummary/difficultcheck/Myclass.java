...
//        m2.name="new name";
        callMe(m1, m2);
//        callMe2(m1,m2);
        //com.py.somesummary.difficultcheck.Myclass@4554617c & com.py.somesummary.difficultcheck.Myclass@74a14482
    ...
    private static void callMe(Myclass... m) {
        //此时m[0]和m[1]都指向m[1](即m2)
        m[0] = m[1];
        //此时m[1]指向的对象(即m2)的name被改成"new name",但m[0]原本指向的对象(m1)却未曾修改过
        m[1].name = "new name";
    }
