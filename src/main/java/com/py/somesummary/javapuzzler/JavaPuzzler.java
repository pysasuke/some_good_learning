...
public class JavaPuzzler {
    ...
    public void decimalPrecision() {
        ...
        System.out.println(new BigDecimal("2.0").subtract(new BigDecimal("1.10")));// 0.90
    }
    ...
    public void intOverflow() {
        ...
        */
        ...
        System.out.println(microsPerDay);  // 86400000000
    }
    ...
    public void threeBug() {
        ...
        switch (rnd.nextInt(2)) {//rnd.nextInt(2)只会返回0、1 两个数字
            ...
            default:
                word = new StringBuffer('M');//每次都会执行default分支语句
        }
        word.append('a');
        word.append('i');
        word.append('n');
