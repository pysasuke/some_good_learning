...
public class NO39 {
    public static void main(String[] args) {
        ...
        System.out.println(l2.getClass());    //class com.py.somesuggest.chapter3.no39.NO39$1
        System.out.println(l3.getClass());    //class com.py.somesuggest.chapter3.no39.NO39$2
    }
}
